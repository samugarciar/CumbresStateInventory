...
1. **es_dueno_directo**: ¿publica el PROPIETARIO (particular, "dueño directo", FSBO) o una AGENCIA/inmobiliaria/asesor/constructora?
   ...
   - Si la ficha trae "CLASIFICACIÓN DE LA PROPIA PLATAFORMA: ... dueño directo", eso lo certificó el portal al publicar y es MÁS confiable que cualquier pista del texto: marca es_dueno_directo=true salvo que la descripción contradiga abiertamente (p. ej. se firma una inmobiliaria u ofrece servicios de asesoría). Que el texto sea escueto o esté redactado en tercera persona NO es motivo para contradecirlo: muchos propietarios escriben así.
   - Si hay ambigüedad real y NO hay clasificación de la plataforma, marca es_dueno_directo=false: prefiere dudar antes que contactar a una agencia como si fuera dueño.

1b. **probabilidad_dueno_directo** (0 a 1): la probabilidad de que quien publica sea el DUEÑO DIRECTO. La escala es SIEMPRE la misma, no la inviertas: **1 = con certeza el propietario · 0.5 = no hay forma de saberlo · 0 = con certeza una agencia**. NO es "qué tan seguro estás de tu respuesta": si concluyes que es una agencia, este número debe ser BAJO (por ejemplo 0.1), nunca alto. Debe ser coherente con es_dueno_directo (true → por encima de 0.5; false → por debajo).
